...
public class Ezekiel {
    ...
    public Ezekiel() {
        ...
        EzekielBook = new Book("ትንቢተ ሕዝቅኤል።", chapters);
    }

    public Book getEzekielBook() {
        return EzekielBook;
    }

    private Chapter chapterOne() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በሠላሳኛው ዓመት በአራተኛው ወር ከወሩም በአምስተኛው ቀን በኮቦር ወንዝ በምርኮኞች መካከል ሳለሁ ሰማያት ተከፈቱ፥ የእግዚአብሔርንም ራእይ አየሁ።\n" +
    ...
    private Chapter chapterTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ እርሱም። የሰው ልጅ ሆይ፥ በእግርህ ቁም እኔም እናገርሃለሁ አለኝ።\n" +
    ...
    private Chapter chapterThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ እርሱም። የሰው ልጅ ሆይ፥ ያገኘኸውን ብላ፤ ይህን መጽሐፍ ብላ፥ ሄደህም ለእስራኤል ቤት ተናገር አለኝ።\n" +
    ...
    private Chapter chapterFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ አንተም፥ የሰው ልጅ ሆይ፥ ጡብን ወስደህ በፊትህ አኑራት የኢየሩሳሌምንም ከተማ ስዕል ሳልባት ክበባት፥\n" +
    ...
    private Chapter chapterFive() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ አንተም፥ የሰው ልጅ ሆይ፥ የተሳለን ጐራዴ ውሰድ፥ እንደ ጢም መላጫ ወደ አንተ ትወስደዋለህ፥ ራስህንና ጢምህንም ትላጭበታለህ፤ ሚዛንንም ውሰድ ጠጕሩንም ትከፋፍላለህ።\n" +
    ...
    private Chapter chapterEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በስድስተኛውም ዓመት በስድስተኛው ወር ከወሩም በአምስተኛው ቀን በቤቴ ተቀምጬ ሳለሁ የይሁዳም ሽማግሌዎች በፊቴ ተቀምጠው ሳሉ፥ በዚያ የጌታ የእግዚአብሔር እጅ በላዬ ወደቀች።\n" +
    ...
    private Chapter chapterNine() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ እርሱም። እያንዳንዳቸው የሚያጠፋ መሣሪያን በእጃቸው ይዘው ከተማይቱን የሚቀሥፉ ይቅረቡ ብሎ በታላቅ ድምፅ በጆሮዬ ጮኸ።\n" +
    ...
    private Chapter chapterTen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ እኔም አየሁ፥ እነሆም፥ በኪሩቤል ራስ ላይ ባለው ጠፈር በላያቸው እንደ ሰንፔር ድንጋይ ያለ እንደ ዙፋን የሚመስል መልክ ተገለጠ።\n" +
    ...
    private Chapter chapterEleven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ መንፈስም አነሣኝ፤ ወደ ፀሐይ መውጫ ወደሚመለከት ወደ እግዚአብሔር ቤትም ወደ ምሥራቁ በር አመጣኝ። እነሆም፥ በበሩ መግቢያ ሀያ አምስት ሰዎች ነበሩ፥ በመካከላቸውም የሕዝቡን አለቆች የዓዙርን ልጅ ያእዛንያንና የበናያስ ልጅ ፈላጥያን አየሁ።\n" +
    ...
    private Chapter chapterThirteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("13", "1 ፤ የእግዚአብሔርም ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterFourteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ከእስራኤልም ሽማግሌዎች አያሌ ሰዎች ወደ እኔ መጥተው በፊቴ ተቀመጡ።\n" +
    ...
    private Chapter chapterNineteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ አንተም በእስራኤል አለቆች ላይ ይህን ሙሾ አሙሽ፥ እንዲህም በል።\n" +
    ...
    private Chapter chapterTwenty() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ እንዲህም ሆነ፤ በሰባተኛው ዓመት በአምስተኛው ወር ከወሩም በአሥረኛው ቀን እግዚአብሔርን ይጠይቁ ዘንድ ከእስራኤል ሽማግሌዎች አያሌ ሰዎች መጡ፥ በፊቴም ተቀመጡ።\n" +
                "2 ፤ የእግዚአብሔርም ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterTwentyFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በዘጠነኛው ዓመት በአሥረኛው ወር ከወሩም በአሥረኛው ቀን የእግዚአብሔር ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterTwentySix() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ እንዲህም ሆነ፤ በአሥራ አንደኛው ዓመት ከወሩ በመጀመሪያው ቀን የእግዚአብሔር ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterTwentyNine() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ በአሥረኛው ዓመት በአሥረኛው ወር ከወሩም በአሥራ ሁለተኛው ቀን የእግዚአብሔር ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterThirtyTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ እንዲህም ሆነ፤ በአሥራ አንደኛው ዓመት በሦስተኛው ወር ከወሩም በመጀመሪያው ቀን የእግዚአብሔር ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterThirtyThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ እንዲህም ሆነ፤ በአሥራ ሁለተኛው ዓመት በአሥራ ሁለተኛው ወር ከወሩም በመጀመሪያው ቀን የእግዚአብሔር ቃል ወደ እኔ እንዲህ ሲል መጣ።\n" +
    ...
    private Chapter chapterThirtySeven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ አንተም፥ የሰው ልጅ ሆይ፥ ለእስራኤል ተራሮች ትንቢት ተናግረህ። የእስራኤል ተራሮች ሆይ፥ የእግዚአብሔርን ቃል ስሙ በል።\n" +
    ...
    private Chapter chapterThirtyEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ የእግዚአብሔርም እጅ በላዬ ነበረ እግዚአብሔርም በመንፈሱ አወጣኝ አጥንቶችም በሞሉባት ሸለቆ መካከል አኖረኝ።\n" +
    ...
    private Chapter chapterFourty() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ አንተም፥ የሰው ልጅ ሆይ፥ በጎግ ላይ ትንቢትን ተናገር እንዲህም በል። ጌታ እግዚአብሔር እንዲህ ይላል። የሞሳሕና የቶቤል ዋነኛ አለቃ ጎግ ሆይ፥ እነሆ፥ እኔ በአንተ ላይ ነኝ፤\n" +
    ...
    private Chapter chapterFourtyOne() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ወደ መቅደሱም አገባኝ፥ የግንቡንም አዕማድ ወርድ በዚህ ወገን ስድስት ክንድ በዚያም ወገን ስድስት ክንድ አድርጎ ለካ።\n" +
    ...
    private Chapter chapterFourtyTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በውጭም አደባባይ በሰሜኑ መንገድ አወጣኝ፥ በልዩውም ስፍራ አንጻርና በሰሜን በኩል ባለው ግቢ ፊት ለፊት ወዳለው ዕቃ ቤት አገባኝ።\n" +
    ...
    private Chapter chapterFourtyThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ ወደ ምሥራቅም ወደሚመለከተው በር አመጣኝ።\n" +
    ...
    private Chapter chapterFourtyFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ወደ ምሥራቅም ወደሚመለከተው በስተ ውጭ ወዳለው ወደ መቅደሱ በር አመጣኝ፤ ተዘግቶም ነበር።\n" +
    ...
    private Chapter chapterFourtyFive() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ርስትም አድርጋችሁ ምድርን በዕጣ በምታካፍሉበት ጊዜ ከምድር የተቀደሰውን የዕጣ ክፍል መባ አድርጋችሁ ወደ እግዚአብሔር ታቀርባላችሁ። ርዝመቱ ሀያ አምስት ሺህ ክንድ ወርዱም ሀያ ሺህ ክንድ ይሆናል፤ በዳርቻው ሁሉ ዙሪያውን የተቀደሰ ይሆናል።\n" +
    ...
    private Chapter chapterFourtySix() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ጌታ እግዚአብሔር እንዲህ ይላል። በውስጠኛው አደባባይ ወደ ምሥራቅ የሚመለከተው በር ሥራ በሚሠራበት በስድስቱ ቀን ተዘግቶ ይቈይ፤ ነገር ግን በሰንበት ቀንና በመባቻ ቀን ይከፈት።\n" +
    ...
    private Chapter chapterFourtySeven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ወደ መቅደሱም መዝጊያ መለሰኝ፤ እነሆም፥ ውኃ ከቤቱ መድረክ በታች ወደ ምሥራቅ ይወጣ ነበር፥ የቤቱ ፊት ወደ ምሥራቅ ይመለከት ነበርና፤ ውኃውም ከቤቱ ከቀኝ ወገን በታች በመሠዊያው በደቡብ በኩል ይወርድ ነበር።\n" +
    ...
    private Chapter chapterFourtyEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ የነገዶችም ስም ይህ ነው። በሔትሎን መንገድ አጠገብ ወደ ሐማት መግቢያ በደማስቆም ድንበር ባለው በሐጸርዔናን በሐማትም አጠገብ በሰሜን በኩል ካለው ከሰሜን ድንበር ይጀምራል። ወርዳቸውም ከምሥራቅ ጀምሮ እስከ ምዕራብ ድረስ ይሆናል። ለዳን አንድ የዕጣ ክፍል ይሆናል።\n" +
