...
public class Romans {
    ...
    public Romans() {
        ...
        RomansBook = new Book("ወደ ሮሜ ሰዎች", chapters);
    }

    public Book getRomansBook() {
    ...
    private Chapter chapterOne() {
        ...
        verses.add(new Verse("1", "ሐዋርያ ሊሆን የተጠራ የኢየሱስ ክርስቶስ ባሪያ ጳውሎስ በነቢያቱ አፍ በቅዱሳን\n" +
    ...
    private Chapter chapterTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ስለዚህ፥ አንተ የምትፈርድ ሰው ሁሉ ሆይ፥ የምታመካኘው የለህም፤ በሌላው በምትፈርድበት ነገር ራስህን ትኰንናለህና፤ አንተው ፈራጁ እነዚያን ታደርጋለህና።\n" +
    ...
    private Chapter chapterThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ የአይሁዳዊ ብልጫው ምንድር ነው? ወይስ የመገረዝ ጥቅሙ ምንድር ነው? በሁሉ ነገር ብዙ ነው።\n" +
    ...
    private Chapter chapterFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ በሥጋ አባታችን የሆነ አብርሃም ምን አገኘ እንላለን?\n" +
    ...
    private Chapter chapterFive() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ በእምነት ከጸደቅን በእግዚአብሔር ዘንድ በጌታችን በኢየሱስ ክርስቶስ ሰላምን እንያዝ፤\n" +
    ...
    private Chapter chapterSix() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ ምን እንላለን? ጸጋ እንዲበዛ በኃጢአት ጸንተን እንኑርን? አይደለም።\n" +
    ...
    private Chapter chapterSeven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ወንድሞች ሆይ፥ ሕግን ለሚያውቁ እናገራለሁና ሰው ባለበት ዘመን ሁሉ ሕግ እንዲገዛው አታውቁምን?\n" +
    ...
    private Chapter chapterEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ በክርስቶስ ኢየሱስ ላሉት አሁን ኵነኔ የለባቸውም።\n" +
    ...
    private Chapter chapterNine() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ብዙ ኀዘን የማያቋርጥም ጭንቀት በልቤ አለብኝ ስል በክርስቶስ ሆኜ እውነትን እናገራለሁ፤\n" +
    ...
    private Chapter chapterTen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ወንድሞች ሆይ፥ የልቤ በጎ ፈቃድና ስለ እስራኤል ወደ እግዚአብሔር ልመናዬ እንዲድኑ ነው።\n" +
    ...
    private Chapter chapterEleven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ። እግዚአብሔር ሕዝቡን ጣላቸውን? እላለሁ። አይደለም እኔ ደግሞ እስራኤላዊና ከአብርሃም ዘር ከብንያምም ወገን ነኝና።\n" +
    ...
    private Chapter chapterTwelve() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ፥ ወንድሞች ሆይ፥ ሰውነታችሁን እግዚአብሔርን ደስ የሚያሰኝና ሕያው ቅዱስም መሥዋዕት አድርጋችሁ ታቀርቡ ዘንድ በእግዚአብሔር ርኅራኄ እለምናችኋለሁ፥ እርሱም ለአእምሮ የሚመች አገልግሎታችሁ ነው።\n" +
    ...
    private Chapter chapterThirteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ነፍስ ሁሉ በበላይ ላሉት ባለ ሥልጣኖች ይገዛ። ከእግዚአብሔር ካልተገኘ በቀር ሥልጣን የለምና፤ ያሉትም ባለ ሥልጣኖች በእግዚአብሔር የተሾሙ ናቸው።\n" +
    ...
    private Chapter chapterFourteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "በእምነት የደከመውንም ተቀበሉት፥ በአሳቡም ላይ አትፍረዱ።\n" +
    ...
    private Chapter chapterFifteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እኛም ኃይለኞች የሆንን የደካሞችን ድካም እንድንሸከም ራሳችንንም ደስ እንዳናሰኝ ይገባናል።\n" +
    ...
    private Chapter chapterSixteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "በክንክራኦስ ባለች ቤተ ክርስቲያን አገልጋይ የምትሆን እኅታችንን ፌቤንን አደራ ብያችኋለሁ፤\n" +
