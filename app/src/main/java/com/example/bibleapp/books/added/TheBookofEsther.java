...
public class TheBookofEsther {
    private Book TheBookofEstherBook;

    public TheBookofEsther() {
        ...
        TheBookofEstherBook = new Book("መጽሐፈ አስቴር።", chapters);
    }

    public Book getTheBookofEstherBook() {
        return TheBookofEstherBook;
    }

    private Chapter chapterOne() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በአርጤክስስም ዘመን እንዲህ ሆነ፤ ይህም አርጤክስስ ከህንድ ጀምሮ እስከ ኢትዮጵያ ድረስ በመቶ ሀያ ሰባት አገሮች ላይ ነገሠ።\n" +
    ...
    private Chapter chapterTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ከዚህም ነገር በኋላ የንጉሡ የአርጤክስስ ቍጣ በበረደ ጊዜ አስጢንና ያደረገችውን የፈረደባትንም ነገር አሰበ።\n" +
    ...
    private Chapter chapterThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ ከዚህም ነገር በኋላ ንጉሡ አርጤክስስ የአጋጋዊውን የሐመዳቱን ልጅ ሐማን ከፍ ከፍ አደረገው፥ አከበረውም፥ ወንበሩንም ከእርሱ ጋር ከነበሩት አዛውንት ሁሉ በላይ አደረገለት።\n" +
    ...
    private Chapter chapterFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ መርዶክዮስም የተደረገውን ሁሉ ባወቀ ጊዜ ልብሱን ቀደደ፥ ማቅም ለበሰ አመድም ነሰነሰ፥ ወደ ከተማይቱም መካከል ወጣ፥ ታላቅም የመረረ ጩኸት ጮኸ።\n" +
    ...
    private Chapter chapterFive() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በሦስተኛውም ቀን አስቴር ልብሰ መንግሥትዋን ለብሳ በንጉሡ ቤት ትይዩ በንጉሡ ቤት በውስጠኛው ወለል ቆመች፤ ንጉሡም በቤቱ መግቢያ ትይዩ በቤተ መንግሥቱ ውስጥ በንጉሡ ዙፋን ላይ ተቀምጦ ነበር።\n" +
    ...
    private Chapter chapterSix() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በዚያም ሌሊት እንቅልፍ ከንጉሡ ሸሸ፤ የዘመኑንም ታሪክ መጽሐፍ ያመጡ ዘንድ አዘዘ፥ በንጉሡም ፊት ተነበበ።\n" +
    ...
    private Chapter chapterSeven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ንጉሡና ሐማም ከንግሥቲቱ ከአስቴር ጋር ለመጠጣት መጡ።\n" +
    ...
    private Chapter chapterEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ በዚያም ቀን ንጉሡ አርጤክስስ የአይሁድን ጠላት የሐማን ቤት ለንግሥቲቱ ለአስቴር ሰጠ። አስቴርም ለእርስዋ ምን እንደ ሆነ ነግራው ነበርና መርዶክዮስ ወደ ንጉሡ ፊት ገባ።\n" +
    ...
    private Chapter chapterNine() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "1 ፤ አዳር በሚባለውም በአሥራ ሁለተኛው ወር ከወሩም በአሥራ ሦስተኛው ቀን፥ የንጉሡ ትእዛዝና አዋጅ ሊፈጸምበት በነበረው ቀን፥ የአይሁድ ጠላቶች ሊሠለጥኑባቸው በነበረው ቀን፥ አይሁድ በጠላቶቻቸው ላይ እንዲሠለጥኑ ነገሩ ተገለበጠ።\n" +
    ...
    private Chapter chapterTen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1","1 ፤ ንጉሡም አርጤክስስ በምድርና በባሕር ደሴቶች ላይ ግብር ጣለ።\n" +
