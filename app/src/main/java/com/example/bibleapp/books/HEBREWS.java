...
public class HEBREWS {
    ...
    public HEBREWS() {
        ...
        HEBREWSBook = new Book("ወደ ዕብራውያን", chapters);
    }

    public Book getHEBREWSBook() {
        return HEBREWSBook;
    }

    private Chapter chapterOne() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ከጥንት ጀምሮ እግዚአብሔር በብዙ ዓይነትና በብዙ ጎዳና ለአባቶቻችን በነቢያት ተናግሮ፥\n" +
    ...
    private Chapter chapterTwo() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ስለዚህ ከሰማነው ነገር ምናልባት እንዳንወሰድ፥ ለእርሱ አብልጠን ልንጠነቀቅ ያስፈልገናል።\n" +
    ...
    private Chapter chapterThree() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ስለዚህ፥ ከሰማያዊው ጥሪ ተካፋዮች የሆናችሁ ቅዱሳን ወንድሞች ሆይ፥ የሃይማኖታችንን ሐዋርያና ሊቀ ካህናት ኢየሱስ ክርስቶስን ተመልከቱ፤\n" +
    ...
    private Chapter chapterFour() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ ወደ ዕረፍቱ ለመግባት ተስፋ ገና ቀርቶልን ከሆነ፥ ምናልባት ከእናንተ ማንም የማይበቃ መስሎ እንዳይታይ እንፍራ።\n" +
    ...
    private Chapter chapterFive() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ሊቀ ካህናት ሁሉ ስለ ኃጢአት መባንና መስዋዕትን ሊያቀርብ ከሰው ተመርጦ ለእግዚአብሔር በሆነው ነገር ሁሉ ስለ ሰው ይሾማልና፤\n" +
    ...
    private Chapter chapterSix() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ስለዚህ የክርስቶስን ነገር መጀመሪያ የሚናገረውን ቃል ትተን ወደ ፍጻሜ እንሂድ፤ መሠረትን ደግመን አንመሥርት፥\n" +
    ...
    private Chapter chapterSeven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "የሳሌም ንጉሥና የልዑል እግዚአብሔር ካህን የሆነ ይህ መልከ ጼዴቅ አብርሃም ነገሥታትን ገድሎ ሲመለስ ከእርሱ ጋር ተገናኝቶ ባረከው፤\n" +
    ...
    private Chapter chapterEight() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ከተናገርነውም ዋና ነገሩ ይህ ነው፤ በሰማያት በግርማው ዙፋን ቀኝ የተቀመጠ እንዲህ ያለ ሊቀ ካህናት አለን፤\n" +
    ...
    private Chapter chapterNine() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ፊተኛይቱም ደግሞ የአገልግሎት ስርዓትና የዚህ ዓለም የሆነው መቅደስ ነበራት።\n" +
    ...
    private Chapter chapterTen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ሕጉ ሊመጣ ያለው የበጎ ነገር እውነተኛ አምሳል ሳይሆን የነገር ጥላ አለውና፥ ስለዚህም በየዓመቱ ዘወትር በሚያቀርቡት በዚያ መሥዋዕት የሚቀርቡትን ሊፈጽም ከቶ አይችልም።\n" +
    ...
    private Chapter chapterEleven() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እምነትም ተስፋ ስለምናደርገው ነገር የሚያስረግጥ፥ የማናየውንም ነገር የሚያስረዳ ነው።\n" +
    ...
    private Chapter chapterTwelve() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "እንግዲህ እነዚህን የሚያህሉ ምስክሮች እንደ ደመና በዙሪያችን ካሉልን፥\n" +
    ...
    private Chapter chapterThirteen() {
        List<Verse> verses = new ArrayList<>();
        verses.add(new Verse("1", "ወንድማማች መዋደድ ይኑር።\n" +
